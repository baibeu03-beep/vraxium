...
const Cluster41Content = () => {
  ...
  const [growthPeriodStats, setGrowthPeriodStats] = useState<GrowthPeriodStats | null>(isDemoMode ? {
    approvedWeeks: 12,
    unapprovedWeeks: 1,
    restWeeks: 1,
    clubBreakWeeks: 0,
  ...
  const [startWeekInfo, setStartWeekInfo] = useState<WeekInfo | null>(isDemoMode ? {
    year: 2024, seasonName: '가을', weekNumber: 14
  } : null);
  const [endWeekInfo, setEndWeekInfo] = useState<WeekInfo | null>(isDemoMode ? {
    year: 2024, seasonName: '가을', weekNumber: 14
  } : null);
