// DEPRECATED — legacy link-only store for cluster-3 Section 5 Detail 10.
// Canonical source: portfolio_top_cards (card_type='detail', read via /api/portfolio-top-cards).
// Front (Cluster3Content.tsx) no longer calls this route.
// TODO(cluster3-legacy-drop): remove this file + user_introductions.portfolio_output_{6..15}
// + portfolio_output_channel_{6..15} columns once migration confirmed.
