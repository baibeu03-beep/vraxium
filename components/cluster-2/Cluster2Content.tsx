            ...
            {introCards.slice(0, 3).map((card, index) => (
              ...
              >
                <svg className="border-tl" xmlns="http://www.w3.org/2000/svg" width="120" height="127" viewBox="0 0 120 127" fill="none">
                  <path d="M1 125.624V18C1 8.61116 8.61116 1 18 1H118.778" stroke={accentInline} strokeWidth="3" strokeLinecap="round" />
                </svg>
                <svg className="border-br" xmlns="http://www.w3.org/2000/svg" width="121" height="104" viewBox="0 0 121 104" fill="none">
                  <path d="M119.18 0.999918V90.345C119.18 96.972 113.807 102.345 107.18 102.345H1.00013" stroke={accentInline} strokeWidth="3" strokeLinecap="round" />
                </svg>
